...
\caption{\textbf{Main analyses tree symmetry distributions.} Distribution of tree symmetry values measured using the corrected Colless index \citep{heard1992patterns}.}
\label{fig:main trees colless dist} 
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width =\textwidth]{figures/assymetrical_trees_colless.pdf}
\caption{\textbf{Asymmetrical trees sensitivity test Colless index distributions.} Distribution of tree symmetry values measured using the corrected Colless index \citep{heard1992patterns}.}
\label{fig:assymetrical trees colless dist} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/discrete_boxplot_assymetrical_50t_trees.pdf}
  \caption{\textbf{Asymmetrical tree discrete disparity error}. This is for the tip-only fossil sampling scheme.} 
  \label{fig:Asymmetrical trees boxplot}
\end{figure}


\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/continuous_boxplot_nodes_tips_sampled.pdf}
  \caption{\textbf{Continuous disparity error across estimation methods using the alternative tip+nodes fossil sampling scheme}. Relative disparity error returned from pre-ordination point ASE (ancestral state estimation), pre-ordination distribution ASE, post-ordination point ASE, post-ordination distribution ASE and no ASE. These disparity errors were calculated across three transition rates (fast (0.9), medium (0.1) and slow (0.01)), five simulated fossil sampling densities (100\%, 50\%, 15\%, 5\% and 0\%) and three disparity metrics (Sum of variances, sum of quantiles and mean pairwise distance). Values closest to 0 (dotted horizontal line) were most accurate; negative errors are under-estimates and positive are over-estimates.} 
  \label{fig:Continuous nodes tips boxplot}
\end{figure}


% \begin{figure}[H]
%   \centering
%   \includegraphics[width=\textwidth]{figures/discrete}
%   \caption{\textbf{Asymmetrical tree discrete disparity error}. This is for the tip-only fossil sampling scheme.} 
%   \label{fig:rm axes discrete boxplot}
% \end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/discrete_boxplot_rm_axes.pdf}
  \caption{\textbf{Discrete boxplot with minimum number of axes retained across all treatments}. This is for the tip-only fossil sampling scheme.} 
  \label{fig:rm axes discrete boxplot}
\end{figure}
