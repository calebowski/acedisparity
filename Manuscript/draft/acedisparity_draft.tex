...
The corresponding trait matrices were subset to match the tips remaining in each down-sampled tree, with extant taxa sampled across all fossil sampling densities.
...
These were then compared to a null of bypassing ancestral state estimation, where only sampled-taxa were used to generate trait spaces.
