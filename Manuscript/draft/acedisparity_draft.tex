...
Continuous data were ordinated using principal components analysis (PCA; \texttt{stats::prcomp} function in R). 
Because PCA requires raw continuous data to calculate covariance, discrete characters were instead converted to distance matrices using the Maximum Observed Rescaled Distance metric (MORD) \citep{lloyd2016estimating} and ordinated using principal coordinates analyses (PCoA) (\texttt{stats::cmdscale} function in R) with the Cailliez correction to deal with negative eigenvalues \citep{cailliez1983analytical}.
...
%TG: worth adding some people here! Maybe put a list of the people that you talked to about your work and won't review it. Robin Beck, Katie Davis, Russel Garwood, Vera Weisbecker. Some more? Also feel free to add people from the office that you think will appreciate it!

\section*{Author Contributions}

All authors designed the study and wrote the manuscript. CS lead the work and ran all the analyses.
%TG: or something like that

\section*{Data Availability}

The data and code to reproduce these results is available at @@@
%TG: add github + dryad link
