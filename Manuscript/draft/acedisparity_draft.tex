...
\begin{abstract}
\noindent
Morphological traits and phylogenies are routinely used to investigate macroevolutionary patterns.
However, our ability to infer patterns in deep-time is limited by the incomplete fossil record.
Ancestral state estimations can be used for both discrete and continuous traits to extend these analyses beyond incomplete fossil data, but these estimates often have high uncertainty.
% This can be particularly challenging when looking at the diversity of traits (disparity analyses).
Determining the most robust workflow for treating this trait state uncertainty during disparity analyses remains a critical challenge.
