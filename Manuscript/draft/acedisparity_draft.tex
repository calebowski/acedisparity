...
Results from the alternative weighted LMMs were consistent with these findings (\autoref{fig:weighted LMM continuous heatmap}, \ref{fig:weighted LMM discrete heatmap}).
