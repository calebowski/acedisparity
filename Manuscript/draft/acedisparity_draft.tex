...
% gavin says to say which model and disparity metric were easiest to estimate.
...
\caption{Heatmap showing the discrete estimated marginal mean (EMM) relative disparity errors for all combinations of estimation method, transition rate and simulated fossil sampling density. Estimated marginal means were calculated from a linear mixed model with a three-way interaction, averaged across disparity metrics.} 
