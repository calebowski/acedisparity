...
These findings were largely congruent under the alternative tips+nodes fossil sampling scheme, albeit we found that excluding ancestral states was marginally better performing when under the sum of quantiles metric across all models (\autoref{fig:Continuous nodes tips boxplot}).
