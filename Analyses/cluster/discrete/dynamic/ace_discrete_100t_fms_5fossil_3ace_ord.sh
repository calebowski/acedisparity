#!/bin/bash
#SBATCH --job-name=100t_discrete_ace_ord
#SBATCH --output=/users/bip24cns/acedisparity/discrete/logs/100t_discrete_ace_ord_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/discrete/logs/100t_discrete_ace_ord_%A_%a.err
...
Rscript /users/$USER/acedisparity/discrete/scripts/dynamic_fms_5fossil_discrete_ace_ordination.R $SLURM_ARRAY_TASK_ID "100t"