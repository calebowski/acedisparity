...
ord_rel <- readRDS(paste0(base_path, sprintf("ord/8269323_ord_rel_%03d.rds", replicate_id)))
ord_sample <- readRDS(paste0(base_path, sprintf("ord/8269323_ord_sample_%03d.rds", replicate_id)))
ord_strict <- readRDS(paste0(base_path, sprintf("ord/8269323_ord_strict_%03d.rds", replicate_id)))
ord_no_ace <- readRDS(paste0(base_path, sprintf("ord/8269323_ord_no_ace_%03d.rds", replicate_id)))
ord_true <- readRDS(paste0(base_path, sprintf("ord/8269323_ord_true_%03d.rds", replicate_id)))
point_post_ord_ace <- readRDS(paste0(base_path, sprintf("ord/8269323_post_ord_point_%03d.rds", replicate_id)))
sample_post_ord_ace <- readRDS(paste0(base_path, sprintf("ord/8269323_post_ord_sample_%03d.rds", replicate_id)))
