...
#SBATCH --output=/users/bip24cns/acedisparity/discrete_crown/logs/50t_discrete_sample_ord_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/discrete_crown/logs/50t_discrete_sample_ord_%A_%a.err
