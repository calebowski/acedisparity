#!/bin/bash
#SBATCH --job-name=150t_post_ord_ace_batch_1
#SBATCH --output=/users/bip24cns/acedisparity/discrete_crown/logs/150t_post_ord_ace_batch1_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/discrete_crown/logs/150t_post_ord_ace_batch1_%A_%a.err
