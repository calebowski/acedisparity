...
#SBATCH --output=/users/bip24cns/acedisparity/discrete_crown/logs/150t_pre_ord_ace_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/discrete_crown/logs/150t_pre_ord_ace_%A_%a.err
...
Rscript /users/$USER/acedisparity/discrete_crown/scripts/dynamic_discrete_crown_pre_ord_ace.R $SLURM_ARRAY_TASK_ID "150t"