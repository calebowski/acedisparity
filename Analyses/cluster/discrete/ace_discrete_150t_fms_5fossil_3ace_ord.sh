#!/bin/bash
#SBATCH --job-name=150t_discrete_ord
#SBATCH --output=/users/bip24cns/acedisparity/randomExtinction/logs/150t_discrete_ord_%A_%03a.out
#SBATCH --error=/users/bip24cns/acedisparity/randomExtinction/logs/150t_discrete_ord_%A_%03a.err
...
Rscript /users/$USER/acedisparity/discrete/scripts/ace_discrete_150t_fms_5fossil_3ace_ord.R $SLURM_ARRAY_TASK_ID