...
write.tree(tree, "../Data/cluster/trees/discrete_01.tre")
...
saveRDS(matrices, "../Data/cluster/discrete/matrices/discrete_matrix_01.rds")
...
saveRDS(fossil_matrices, "../Data/cluster/discrete/matrices/fossil_matrices_01.ds")
...
saveRDS(fossil_anc, "../Data/cluster/discrete/matrices/discreteanc_01.rds")
saveRDS(sample_fossil_anc, "../Data/cluster/discrete/matrices/sampleanc_01.rds")
saveRDS(relative_fossil_anc, "../Data/cluster/discrete/matrices/relanc_01.rds")
saveRDS(strict_fossil_anc, "../Data/cluster/discrete/matrices/strictanc_01.rds")
...
saveRDS(ord_sample, "../Data/cluster/discrete/matrices/ord_sample_01.rds")
...
saveRDS(ord_rel, "../Data/cluster/discrete/matrices/ord_rel_01.rds")
...
saveRDS(ord_strict, "../Data/cluster/discrete/matrices/ord_strict_01.rds")
...
saveRDS(ord_true, "../Data/cluster/discrete/matrices/ord_true_01.rds")
...
saveRDS(ord_no_ace, "../Data/cluster/discrete/matrices/ord_noace_01.rds")
