...
write.tree(tree, "/mnt/parscratch/users/bip24cns/acedisparity/randomExtinction/out/trees/TEST_rand_ext_tree.tre")
...
cat("Started ACE at", format(Sys.time(), "%H:%M:%S"), "\n")
...
cat("Finished ACE at", format(Sys.time(), "%H:%M:%S"), "\n")
...
cat("Started distances at", format(Sys.time(), "%H:%M:%S"), "\n")
...
cat("Finished distances at", format(Sys.time(), "%H:%M:%S"), "\n")

cat("Started ORD at", format(Sys.time(), "%H:%M:%S"), "\n")
...
# cat("ord sample finished")

cat("Finished ORD at", format(Sys.time(), "%H:%M:%S"), "\n")
...
saveRDS(ord_sample, "/mnt/parscratch/users/bip24cns/acedisparity/randomExtinction/out/ord/rand_ext_ord_sample_test.rds")

cat("Finished saving sample ORD at", format(Sys.time(), "%H:%M:%S"), "\n")
...
cat("Started disparity calculation at", format(Sys.time(), "%H:%M:%S"), "\n")
...
saveRDS(sum_var_true, "/mnt/parscratch/users/bip24cns/acedisparity/randomExtinction/out/disp/TEST_rand_ext_sum_var_true_.rds")
...
cat("Finished disparity calculation at", format(Sys.time(), "%H:%M:%S"), "\n")
