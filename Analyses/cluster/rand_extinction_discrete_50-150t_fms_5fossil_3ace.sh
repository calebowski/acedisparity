#!/bin/bash
#SBATCH --job-name=TEST100rand_ext_50-150t
#SBATCH --output=/users/bip24cns/acedisparity/randomExtinction/logs/TEST100rand_ext_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/randomExtinction/logs/TEST100rand_ext_%A_%a.err
...
#SBATCH --mem=90g                     # adjust based on memory needs
