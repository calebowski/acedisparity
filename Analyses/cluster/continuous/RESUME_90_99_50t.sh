#!/bin/bash
#SBATCH --job-name=RESUME90_99_acecontinuous50tord
#SBATCH --output=/users/bip24cns/acedisparity/continuous/logs/RESUME_ord_continuous_50t_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/continuous/logs/RESUMEord_continuous_50t_%A_%a.err
#SBATCH --array=90,99                   # 100 replicates
