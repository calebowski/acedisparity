...
dir.create("../Data/continuous/lmm/weighted")
dir.create("../Data/continuous/lmm/weighted/tables")
lmm_weighted_path <- "../Data/continuous/lmm/weighted/"
...
```{R}
pdf("../Manuscript/figures/weighted_continuous_diagnostic_plot.pdf")
par(mfrow = c(2, 2))
