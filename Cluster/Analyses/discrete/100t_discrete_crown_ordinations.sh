#!/bin/bash
#SBATCH --job-name=100t_discrete_ordinations
#SBATCH --output=/users/bip24cns/acedisparity/discrete_crown/logs/100t_ord_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/discrete_crown/logs/100t_ord_%A_%a.err
...
Rscript /users/$USER/acedisparity/discrete_crown/scripts/dynamic_discrete_crown_ordinations.R $SLURM_ARRAY_TASK_ID "100t" "8561556"