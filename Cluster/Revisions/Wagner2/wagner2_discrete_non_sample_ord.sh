#!/bin/bash
#SBATCH --job-name=wagner2_50t_non_sample_ord
#SBATCH --output=/users/bip24cns/acedisparity/revisions/logs/wagner2_50t_non_sample_ord_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/revisions/logs/wagner2_50t_non_sample_ord_%A_%a.err
...
Rscript /users/$USER/acedisparity/revisions/scripts/wagner2_discrete_non_sample_ord.R $SLURM_ARRAY_TASK_ID "50t" "11532243"