#!/bin/bash
#SBATCH --job-name=wagner2_post_ord_ace_batch_1
#SBATCH --output=/users/bip24cns/acedisparity/revisions/logs/wagner2_post_ord_ace_batch1_%A_%a.out
#SBATCH --error=/users/bip24cns/acedisparity/revisions/logs/wagner2_post_ord_ace_batch1_%A_%a.err
