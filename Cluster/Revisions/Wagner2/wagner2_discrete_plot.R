...
for (method in methods) {
  results[[method]] <- list()
  for(i in 1:100) {
    file_path <- file.path("..", "..", "Data",  "revisions", "wagner2", "discrete",
                          "disparity",
                          sprintf("11532243_%s_%03d.rds", method, i))
...
ggsave("../../../Manuscript/draft/figures/discrete_boxplot_nodes_tips_sampled_punc_eq.png", boxplot_plot_all, , width = 18, height = 14, dpi = 700, units = "in", bg = "white")
