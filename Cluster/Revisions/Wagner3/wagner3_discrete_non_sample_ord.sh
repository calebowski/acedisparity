#!/bin/bash
#SBATCH --job-name=wagner3_50t_non_sample_ord
#SBATCH --output=/users/bip24cns/acedisparity/revisions/logs/wagner3_50t_non_sample_ord_%A_%a.out
...
Rscript /users/$USER/acedisparity/revisions/scripts/wagner3_discrete_non_sample_ord.R $SLURM_ARRAY_TASK_ID "50t" "11632272"