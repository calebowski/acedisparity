...
traits <- list(bm = bm, bm_t = bm_t, ou = ou )
...
fossilised_high <- lapply(matrices, fossil.pres.alt, trees = crown_tree, preservation = 0.5, type = "continuous", seed = set_seed)
all_fossil <- lapply(matrices, fossil.pres.alt, trees = crown_tree, preservation = 1.0, type = "continuous", seed = set_seed)
fossilised_med <- lapply(matrices, fossil.pres.alt, trees = crown_tree, preservation = 0.15, type = "continuous", seed = set_seed)
fossilised_low <- lapply(matrices, fossil.pres.alt, trees = crown_tree, preservation = 0.05, type = "continuous", seed = set_seed)
